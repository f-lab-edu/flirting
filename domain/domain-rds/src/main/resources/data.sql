...
(user_profile_id, username, birthdate, gender, sido, sigungu, mbti, prefer_mbti, location, company_id)
values (1, 'test', '1990-01-01', 'M', '서울', '강남구', 'INTJ', 'ENFP', point(37.496486063, 127.028361548), 1);

insert into service.company (name, domain, icon_url) values ('google', 'gmail.com', 'https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png');
