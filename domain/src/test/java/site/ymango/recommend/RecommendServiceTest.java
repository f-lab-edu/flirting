...
class RecommendServiceTest {
  ...
  void test01() {
    ...
    // when
    recommendService.createRecommendProfile(userId, userProfileId, RecommendType.DAILY_RECOMMEND);
  ...
  void test02() {
    ...
    // when
    recommendService.createRecommendProfile(createdUser.userId(), createdUser.userProfile().userProfileId(), RecommendType.DAILY_RECOMMEND);

    // then
    var recommendProfiles = recommendService.getRecommendProfiles(createdUser.userId());
  ...
  void test03() {
    ...
    recommendService.deleteRecommendProfile(recommendProfile.recommendProfileId());
  ...
  void test04() {
    ...
    var recommendProfiles = recommendService.getRecommendProfiles(createdUser.userId());
    RecommendProfile recommendProfile = recommendProfiles.get(0);
    recommendService.rateRecommendProfile(recommendProfile.recommendProfileId(), 5);
